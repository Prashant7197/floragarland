...
<body>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo" style="height: auto;">
                    <a href="/admin" class="app-brand-link m-auto ">
                        <span class="app-brand-logo demo">
                            <img src="{{ env('APP_LOGO') }}" style="width: 200px;" />
                        </span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item px-3 my-2  text-uppercase">
                       <select id="select_lawn" class="form-control"></select>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="/vendor/lawns" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-crown"></i>
                            <div data-i18n="Boxicons">Lawn</div>
                        </a>
                    </li>
    ...
    <script>
        function getLawn(){
            $.get('/vendor/get/lawn',{},function(response){document.getElementById('select_lawn').innerHTML = response.html;
            })
        }
        getLawn();
